...
public class TopSortAlgorithm {
    ...
    // topological sorts
    private String allTopologicalSortsUtil(boolean[] visited,
    ...
    public String allTopologicalSorts() {
        ...
        return allTopologicalSortsUtil(visited, indegree, stack);
    }
}

...
public class MatrixChainMultiply {
    ...
    public void printParenthesis(int i, int j, int n, int[][] bracket)
    {

        // If only one matrix left in current segment
        if (i == j) {
            DynamicWindow.ret.append(name++);
            return;
        }
        DynamicWindow.ret.append("(");
    ...
    // function
    // https://goo.gl/k6EYKj
    public void matrixChainOrder(int p[], int n)
    {
        /*
        ...
        // and so on
        name = 'A';
        DynamicWindow.ret.append("Optimal Parenthesization is : ");
